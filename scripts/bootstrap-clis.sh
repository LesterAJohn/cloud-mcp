...
link_cli alibaba aliyun "${ALIBABA_CLI_BIN:-}"
link_cli digitalocean doctl "${DIGITALOCEAN_CLI_BIN:-}"
link_cli ibmcloud ibmcloud "${IBMCLOUD_CLI_BIN:-}"
link_cli tencent tccli "${TENCENT_CLI_BIN:-}"
link_cli huawei hcloud "${HUAWEI_CLI_BIN:-}"
